...
String defContent[2] = {"0190939510232820030719051290N","0285879010232530100719050630N"};
...
uint8_t lightStart = 11; uint8_t lightEnd = 20;
uint8_t wetHour = 0; uint8_t wetInv = 2; uint8_t wetDur = 15; 
...
unsigned long lastRevTime[RADIO_COUNT] = {0, 0, 0};
unsigned long lastRevMinTime = 0;
unsigned long vfanOnSectionTime = 0; //time count of vfan sectional operation time
void printTentEnv(byte env);
unsigned long lastSwitchTimeVFan = 0;
unsigned long lastSwitchTimeMist = 0;
boolean shtSensorHealth = true;
