/*
  MHZ19B_uart.h - MH-Z19 CO2 sensor library for ESP-WROOM-02/32(ESP8266/ESP32) or Arduino
  version 0.3
...
private:
	...
	int getSerialData(MHZ19B_DATA flg);
	...
	uint8_t setrange[REQUEST_CNT]		= {0xff, 0x01, 0x99, 0x00, 0x00, 0x00, 0x00, 0x00};
